...
def get_context(context):
    ...
    drawing_permission_details_1 = frappe.db.get_all('Drawing Permission Item',{'parent': ['in', context.drawing_permissions], 'child_status': 'Shared', 'date_based_sharing': 0},['name', 'child_item_code', 'child_item_code.item_name as item_name', 'file_url', 'views', 'views_allowed', 'parent'])
    drawing_permission_details_2 = frappe.db.get_all('Drawing Permission Item',{'parent': ['in', context.drawing_permissions], 'child_status': 'Shared', 'date_based_sharing': 1, 'from_date': ['<=', frappe.utils.nowdate()]},['name', 'child_item_code', 'child_item_code.item_name as item_name', 'file_url', 'views', 'views_allowed', 'parent'])
